...
export const mockQuestions: Question[] = [
  {
    ...
    scene: "선착장 도착",
    story:
      "배가 선착장에 닿자, 바닷소금 냄새와 깃발 소리가 섞여 들려온다. 멀리 캠프 광장엔 안내단 선배가 손을 흔든다. 팀원들도 하나둘 내리기 시작했다.",
    text: "가장 먼저 손이 가는 일은?",
    type: "choice",
    options: [
      {
  ...
  },
  {
    ...
    scene: "역할 정하기",
    story:
      "광장 한가운데, 너희 팀만의 이름표를 붙일 자리가 마련되어 있다. 안내단 선배가 말한다. “낮 코스는 팀이 함께할수록 재미있어. 각자 맡을 역할을 정해 볼까?”",
    text: "맡고 싶은 역할은?",
    type: "choice",
    options: [
      {
        id: "q2-c",
        label: "탐험 시간과 준비물을 체크하는 기록 담당",
        primary: "C",
      },
      {
        id: "q2-a",
        label: "길 표시와 팀 깃발을 보기 좋게 만드는 표시 담당",
        primary: "A",
      },
      {
        id: "q2-s",
        label: "친구들의 컨디션과 분위기를 살피는 케어 담당",
        primary: "S",
      },
      {
        id: "q2-r",
        label: "짐을 옮기고 현장에서 필요한 것을 만드는 준비 담당",
        primary: "R",
      },
      {
        id: "q2-e",
        label: "다음 이동 방향을 제안하고 팀을 모으는 진행 담당",
        primary: "E",
      },
      {
        id: "q2-i",
        label: "지형과 단서를 살펴 안전한 길을 찾는 탐색 담당",
        primary: "I",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "q3-c",
        label: "남은 물품과 시간을 살피고, 빠진 위험요소를 표시한다.",
        primary: "C",
        secondary: "I",
      },
      {
        id: "q3-a",
        label: "눈에 잘 띄는 표식을 그리고, 돌과 나뭇가지로 완성한다.",
        primary: "A",
        secondary: "R",
      },
      {
        id: "q3-s",
        label: "친구들 의견을 먼저 듣고, 다 같이 할 수 있는 방식으로 맞춘다.",
        primary: "S",
        secondary: "E",
      },
      {
        id: "q3-r",
        label: "머물 자리를 직접 만들면서 필요한 순서도 함께 잡는다.",
        primary: "R",
        secondary: "C",
      },
      {
      ...
      {
        id: "q3-i",
        label: "어느 길이 안전한지 살피고, 친구들이 걱정하는 점도 확인한다.",
        primary: "I",
        secondary: "S",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "q4-a",
        label: "천, 돌, 나뭇잎으로 멀리서도 보이는 신호물을 구상한다.",
        primary: "A",
        secondary: "E",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "q5-a",
        label: "서로 다른 생각을 그림이나 말로 풀어 보여주고 차이를 짚는다.",
        primary: "A",
        secondary: "I",
      },
      {
        id: "q5-e",
        label: "선택지를 두세 개로 줄이고, 바로 시도할 방법을 제안한다.",
        primary: "E",
        secondary: "R",
      },
      {
        id: "q5-s",
        label: "감정이 상한 친구 이야기를 듣고, 말할 순서를 차분히 잡는다.",
        primary: "S",
        secondary: "C",
      },
      {
        id: "q5-i",
        label: "각 의견의 이유를 따져보고, 걱정되는 점도 함께 확인한다.",
        primary: "I",
        secondary: "S",
      },
      {
        id: "q5-c",
        label: "나온 의견을 표나 그림으로 정리해 모두가 볼 수 있게 한다.",
        primary: "C",
        secondary: "A",
      },
      {
        id: "q5-r",
        label: "계속 말로만 정하기보다, 가능한 방법을 먼저 시험해본다.",
        primary: "R",
        secondary: "E",
      },
    ],
  },
  {
    ...
    scene: "오늘의 기록",
    story:
      "해가 지기 전, 캠프로 돌아왔다. 게시판 앞에 오늘의 발견을 붙일 자리가 비어 있다. 멀리 저녁 하늘에 별빛이 보이기 시작한다. 오늘의 탐험을 어떻게 남길까?",
    text: "나는 어떻게 할까?",
    type: "choice",
    options: [
      {
